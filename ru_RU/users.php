...
return array(
	...
	'username' => 'Логин',
	'username_explain' => '',
	'username_missing' => 'Пожалуйста введите логин. Может содержаться до %s букв.',
	...
	'created' => 'Профиль пользователя добавлен.',
	'deleted' => 'Профиль пользователя удален.',
	'delete_error' => 'Вы не можете удалить свой профиль.',
	'login_error' => 'Логин или пароль неверны.',
	'logout_notice' => 'Вы вышли.',
	'recovery_sent' => 'Мы выслали вам письмо с инструкциями по восстановлению пароль.',
